Category = {
    "зефир": ["сахарная пудра", "орех", "агар", "сахар", "коробка", "смородина", "фисташка", "миндаль",
              ...
              "кондитер", "шоколад", "темный", "белый", "крахмал","какао","пудра","лента","бумага для выпечки","изюм",
              "налог","замороженная","кислота"],
    ...
    'фрукты': ['яблоки', "фрукты", 'груша', 'апельсин','персик', 'банан', 'персик', 'абрикос', 'чернослив', 'арбуз',
               'слива', 'дыня', 'вишня', 'киви',"клубника", "черника", "лимон", "черешня","мандарин","хурма",
               "ананас","ягоды","гранат"],
    ...
    'мясо': ['колбаса', 'курица', 'шея', 'фарш', 'говядина', 'сосиски', 'мясо',"грудка", "шейка","свинина","ветчина",
             "рыба","окорочка","форель","хамон","салями","бекон","скумбрия","лосось","прошутто"],
    'хлеб': ['шоти', 'хлеб','лаваш',"ромашка","багет","бублик"],
    "яйца": ["яйца",],
    'п/фабрикаты': ['пельмени', 'хинкали', 'курица-гриль', "блинчики","блины"],
    'крупы': ['макароны','спагетти' ,'булгур','мука','рис', "паста", "лапша","горох","овсянка","гречка","перловка",
              "хлопья"],
    "др. продукты": ["Carrefour","Назилбе", "подсолнечное масло", "соус", "майонез", "сода","продукты","водоросли",
                     "соль", "уксус", "томатная паста","специи", "аджика","арахис","кетчуп","огурчик","ори набиджи"],
    'вкусняшки': ['печенье', 'Барни', 'шоколадка', 'сникерс', 'сушки', 'пироженка', 'булочка', 'гамбургер',"симит",
                  "фаст фуд","пицца","MMs","конфеты","мед",'пирожок', 'хачапури', "пирожок", "мороженое", "жвачка",
                  "чипсы","вафли","хот-дог", "круасан","пикник","пироговая","вкусняшки","чурчхела"],
    'напитки': ['сок', 'газировка', 'кола', 'компот', 'минералка','чай','кофе', "растворимый", "Борджоми","напиток",
                "мин.вода","бутилирован","спирт","глинтвейн","коктейль","лавацца"],
    "животные": ["корм", "котята", "глистогон", "смесь", "паштет", "собак", "несквик", 'бентонит', "пеленки", "кошк",
                 "еда котам","каниверм", "котёнк"],
    'алкоголь': ['пиво', 'шампанское', 'вино', 'чача', 'коньяк', 'целикаури', 'саперави', 'игристое вино',"консервы"],
    "бытовая химия":["порошок", "стиральный порошок", "мыло", "хозяйствен", "шампунь",
    ...
    'Уля':['театральная студия',"Уле","Ули", 'театр','подготовка к школе','гимнастика', "канцелярия", "картон",
           ...
           "мастер класс", "Ульяна","занятия", "ДР","сандали","кросовки","шапка","детский центр","шарики","сапоги",
           "подарок","цветы","букет"],
    ...
    "ремонт": ["гидроизоляция","шлифовк","растворитель", "краска","канализация","ключ","грунтовка","шкурка","гипсов",
               "душ","клей","двери","кухню","шпатлевка","шпатель","скотч брайт","труб","радиатор","трапик","фитинг",
"правило","анкер","автомат","лампочка","цемент","отопление","раковин", "чашка алмаз", "подложка","порожек","маяки",
               "свп","зажим","гвозди","сифон","шторы","плинтус","уголки","соединения"],
    'кафе': ['кафе', 'Dona', 'Дона',"столовка", "ужин"],
    "аптека":["аптека", "бинт", "пластины","презерватив", "прокладки","мазь","зиртек", "зубная нить","зубная паста",
              "зубная щетка","хлоргексидин","гигиены","гинеколог","врач","лекарства","спрей","линекс"],
    'транспорт':['проезд','такси', "автобус","транспорт","жд","билет"],
    "услуги": ['стрижка',"DHL","ремонт","теннис","гостиница"],
    "без категории": ["без категории"],
    "крупные траты": ["кондиционер","холодильник","дегидратор","посудомойка","духовка", "радиаторы","стиральная "
                                                                                                    "машинка"]
}
